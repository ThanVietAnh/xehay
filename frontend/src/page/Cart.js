...
import emptyCartImage from "../assert/empty.gif"
                ...
                {productCartItem[0] ?
                    <div className='my-4 flex gap-3'>
                        ...
                        <div className='w-full max-w-md  ml-auto'>
                            ...
                            <button className="bg-red-500 hover:bg-red-600 w-full text-lg font-bold py-2 text-white " onClick={handlePayment}>
                                Payment
                            </button>
                        </div>
                    </div>
