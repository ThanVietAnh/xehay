                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <p class="text-normal text-lg sm:text-xl font-medium text-gray-600 dark:text-gray-400 mt-2">
                            Thanks for using our online comunication form. We look forward to serving you!!!
                        </p>
                    ...
                    <form class="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" class="md:w-32 bg-red-500 hover:bg-red-700 text-black font-bold py-3 px-6 rounded-lg mt-3  transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
