            ...
            <div className='flex items-center h-full justify-between'>
                ...
                <div className='flex item-center gap-4 md:gap-7'>
                    <nav className='gap-5 md:gap-7 text-base md:text-lg hidden md:flex'>
                        <Link to={""}>Home</Link>
                        <Link to={"menu/65311152ef83266ae4ff68a5"}>Menu</Link>
                    ...
                    <div className='text-slate-600'onClick={handleshowMenu}>
                        ...
                        {showMenu && (
                            <div className='absolute right-2 bg-white py-2  shadow drop-shadow-md flex flex-col min-w-[120px] text-center'>
                                {
                                    userData.email === process.env.REACT_APP_ADMIN_EMAIL && <Link to={'newcar'} className='whitespace-nowrap cursor-pointer px-2'>New Car</Link>
                                }
                                ...
                                <nav className='text-base md:text-lg flex flex-col md:hidden'>
                                    ...
                                    <Link to={"menu/65311152ef83266ae4ff68a5"}className='px-2 py-1'>Menu</Link>
